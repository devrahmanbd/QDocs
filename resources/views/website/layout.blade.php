...
<div class="ud-header absolute top-0 left-0 z-40 flex w-full items-center bg-transparent">
    ...
    <a href="{{$base_url}}/#home" class="navbar-logo block w-full py-5">
        @if(!empty($super_settings['logo']))
            <img src="{{config('app.url')}}/uploads/{{$super_settings['logo']}}" alt="{{$super_settings['workspace_name'] ?? config('app.name')}}" class="header-logo w-full" style="height: 55px; width: 55px;">
        @else
            <img src="{{config('app.url')}}/uploads/system/qdocs.svg" alt="{{$super_settings['workspace_name'] ?? config('app.name')}}" class="header-logo w-full" style="height: 55px; width: 55px;">
        @endif
    </a>
</div>
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2">
                <div class="mb-10 w-full">
                    ...
                    <a href="{{$base_url}}" class="block navbar-logo  w-full py-5">
                        ...
                        @else
                            <img src="{{config('app.url')}}/uploads/system/qdocs.svg" alt="{{$super_settings['workspace_name'] ?? config('app.name')}}" class="header-logo  max-h-[35px]">
                        @endif
                    </a>
