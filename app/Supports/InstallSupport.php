...
class InstallSupport{
    ...
    public static function createPrimaryData($user)
    {
        ...
        add_activity($workspace_id, $user->first_name.' '.__('installed QDocs'), $user->id);
        ...
        $documents = [
            [
                ...
                'content' => '<h2>Getting Started</h2><p>Hey <strong>'.$user->first_name.'!</strong> </p><p>You have just installed QDocs. </p><p>It will help you to create, organize, and share your business and personal documents. </p><p>Make word documents and spreadsheets, edit images, quickly share files and screenshots, and more. </p><p>During your installation, the system created some sample documents to get to know your QDocs and its modules. This document and other documents generated during installation are sample documents. You may delete them.</p>',
            ],
            [
            ...
            [
                ...
                'content' => 'Upload your images, and your master images will remain the same on your QDocs. Then you can edit them and download your changes.',
            ],
            [
        ...
        $default_settings = [
            'workspace_name' => config('app.name') ?? 'QDocs',
            'logo' => 'system/qdocs.svg',
        ];
