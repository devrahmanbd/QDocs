...
function office_create_saas_primary_data($user)
{
    ...
    $post->settings = [
        ...
        'signup_subtitle' => __('Get Started with QDocs for Free'),
        'signup_reasons' => [
        ...
        'feature_highlight_section_name' => __('Why QDocs?'),
        'feature_highlight_title' => __('QDocs is made with you in mind!'),
...
',
        ...
        'about_section_subtitle' => __('QDocs is a simple, lightweight office suite on the Cloud. Create, Edit, and Share to improve your work efficiency: share files, texts, links, and more with access logs. Know who is viewing and from which device and IP. Export to PDF and more.'),
        ...
        'footer_business_short_description' => 'QDocs improves individual and business productivity. It lets you create and share files, texts, spreadsheets, and more.',
    ];
...
<p>This privacy notice for QDocs ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you: <br>Visit our website at <a href="https://www.QDocs.com">https://www.QDocs.com</a>, or any website of ours that links to this privacy notice </p>
...
<p>
  <br>What personal information do we process? When you visit, use, or navigate our Services, we may process personal information depending on how you interact with QDocs and the Services, the choices you make, and the products and features you use. Click&nbsp;here&nbsp;to learn more.
</p>
<p>
...
<p>
  <br>Want to learn more about what QDocs does with any information we collect? Click&nbsp;here&nbsp;to review the notice in full.
</p>
<p>
...
<p>Welcome to&nbsp;QDocs!</p>
<p>These terms and conditions outline the rules and regulations for the use of&nbsp;QDocs\'s Website, located at <a href="https://www.QDocs.com" target="_blank" rel="noopener">www.QDocs.com</a>.</p>
<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use&nbsp;QDocs&nbsp;if you do not agree to take all of the terms and conditions stated on this page.</p>
...
<p>We employ the use of cookies. By accessing&nbsp;QDocs, you agreed to use cookies in agreement with the&nbsp;QDocs\'s Privacy Policy.</p>
<p>Most interactive websites use cookies to let us retrieve the user\'s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
<h3><strong>License</strong></h3>
<p>Unless otherwise stated,&nbsp;QDocs&nbsp;and/or its licensors own the intellectual property rights for all material on&nbsp;QDocs. All intellectual property rights are reserved. You may access this from&nbsp;QDocs&nbsp;for your own personal use subjected to restrictions set in these terms and conditions.</p>
<p>You must not:</p>
<ul>
<li>Republish material from&nbsp;QDocs</li>
<li>Sell, rent or sub-license material from&nbsp;QDocs</li>
<li>Reproduce, duplicate or copy material from&nbsp;QDocs</li>
<li>Redistribute content from&nbsp;QDocs</li>
</ul>
<p>This Agreement shall begin on the date hereof.</p>
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website.&nbsp;QDocs&nbsp;does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of&nbsp;QDocs,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws,&nbsp;QDocs&nbsp;shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
<p>QDocs&nbsp;reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
...
<p>You hereby grant&nbsp;QDocs&nbsp;a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of&nbsp;QDocs; and (d) the link is in the context of general resource information.</p>
<p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party\'s site.</p>
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to&nbsp;QDocs. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
...
<p>No use of&nbsp;QDocs\'s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
